...
public class EntityUnderworldSheep extends EntityAnimal implements IShearable
{
    ...
    public EntityUnderworldSheep(World par1World)
    {
        super(par1World);
        ...
        this.tasks.addTask(5, new EntityAIAttackOnCollide(this, EntityPig.class, 1.0D, false));
        this.tasks.addTask(2, new EntityAIMate(this, 1.0D));
        this.tasks.addTask(3, new EntityAITempt(this, 1.1D, Items.porkchop, false));
    ...
    public EntityUnderworldSheep createChild(EntityAgeable par1EntityAgeable)
    {
        EntityUnderworldSheep entitysheep = (EntityUnderworldSheep)par1EntityAgeable;
        EntityUnderworldSheep entitysheep1 = new EntityUnderworldSheep(this.worldObj);
    ...
    private int func_90014_a(EntityAnimal par1EntityAnimal, EntityAnimal par2EntityAnimal)
    {
        ...
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.field_90016_e, ((EntityUnderworldSheep)par1EntityAnimal).worldObj);
        int k;
    ...
    {
        return 15 - ((EntityUnderworldSheep)par1EntityAnimal).getFleeceColor();
    }
