...
public class TelporterUnderworld extends Teleporter {
            ...
            for (int i = -2; i <= 2; i++) {
                for (int j = -2; j <= 2; j++) {
                    for (int k = -1; k < 3; k++) {
                        ...
                        boolean flag = k < 0;
                        this.worldServerInstance.setBlock(x2, y2, z2, flag ? MythicalBlocks.blockPortal : Blocks.air);
                    }
                }
            }

            entity.setLocationAndAngles((double) entity_x, (double) entity_y, (double) entity_z, entity.rotationYaw, 0F);
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8) {
            ...
            for (l3 = l - short1; l3 <= l + short1; ++l3) {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1) {
                    ...
                    for (int i2 = this.worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2) {
                        if (this.worldServerInstance.getBlock(l3, i2, l1) == MythicalBlocks.blockPortal) {
                            while (this.worldServerInstance.getBlock(l3, i2 - 1, l1) == MythicalBlocks.blockPortal) {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D) {
            if (flag) {
                this.destinationCoordinateCache.add(j1, new TelporterUnderworld.PortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
            ...
            if (this.worldServerInstance.getBlock(i - 1, j, k) == MythicalBlocks.blockPortal) {
                i4 = 2;
            }
            ...
            if (this.worldServerInstance.getBlock(i, j, k - 1) == MythicalBlocks.blockPortal) {
                i4 = 3;
            }
        ...
        for (i3 = 0; i3 < 4; ++i3) {
            for (j3 = 0; j3 < 4; ++j3) {
                for (k3 = -1; k3 < 4; ++k3) {
                    ...
                    this.worldServerInstance.setBlock(l3, i4, j4, (Block)(flag ? Blocks.soul_sand : MythicalBlocks.blockPortal), 0, 2);
                }
            }
    ...
    public void removeStalePortalLocations(long par1) {
        if (par1 % 100L == 0L) {
            ...
            while (iterator.hasNext()) {
                ...
                PortalPosition portalposition = (TelporterUnderworld.PortalPosition) this.destinationCoordinateCache.getValueByKey(olong.longValue());
