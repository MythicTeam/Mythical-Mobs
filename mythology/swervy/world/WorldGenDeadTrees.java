package mythology.swervy.world;
...
public class WorldGenDeadTrees extends WorldGenAbstractTree {
    ...
    public WorldGenDeadTrees(boolean par1) {
        this(par1, 4, 0, 0, false);
    }

    public WorldGenDeadTrees(boolean par1, int par2, int par3, int par4, boolean par5) {
        super(par1);
                ...
                if (isSoil && y < 256 - l - 1) {
                            ...
                            for (int k2 = z - l1; k2 <= z + l1; ++k2) {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || rand.nextInt(2) != 0 && i3 != 0) {
                                    ...
                                    if (block1.isAir(world, i2, k1, k2) || block1.isLeaves(world, i2, k1, k2)) {
                                        this.setBlockAndNotifyAdequately(world, i2, k1, k2, Resources.blockDeadLeaf, this.metaLeaves);
                                    }
                                }
                            }
                        }
                    ...
                    for (k1 = 0; k1 < l; ++k1) {
                        ...
                        if (block.isAir(world, x, y + k1, z) || block.isLeaves(world, x, y + k1, z)) {
                            this.setBlockAndNotifyAdequately(world, x, y + k1, z, Resources.blockDeadLog, this.metaWood);
