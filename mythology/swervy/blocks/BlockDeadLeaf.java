...
public class BlockDeadLeaf extends BlockLeavesBase implements IShearable
{
    int[] field_150128_a;
    ...
    public BlockDeadLeaf(String string, Material p_i45394_1_, CreativeTabs tabMythicalUnderworld)
    {
        super(Material.leaves, false);
		this.setCreativeTab(tabMythicalUnderworld)
		.setBlockName(string)
		.setBlockTextureName(MythologyMod.modid + ":deadLeaf");
        this.setTickRandomly(true);
        this.setHardness(0.2F);
        this.setLightOpacity(1);
        this.setStepSound(soundTypeGrass);
        GameRegistry.registerBlock(this, "deadLeaf");
    }
    ...
    {
        return Item.getItemFromBlock(MythologyMod.deadSapling);
    }
