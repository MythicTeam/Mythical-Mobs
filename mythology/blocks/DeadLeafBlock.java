...
public class DeadLeafBlock extends BlockLeavesBase implements IShearable {
    int[] field_150128_a;
    ...
    public DeadLeafBlock() {
        super(Material.leaves, false);
        this.setCreativeTab(MythologyMod.tabMythicalUnderworld);
        this.setBlockTextureName(MythologyMod.modid + ":blocks/underworld/" + "deadLeaves");
        this.setTickRandomly(true);
        this.setHardness(0.2F);
        this.setLightOpacity(1);
        this.setStepSound(soundTypeGrass);
        this.setBlockName("deadLeaf");
