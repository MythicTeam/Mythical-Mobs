...
public class BlockBlueFire extends BlockFire {
    ...
    public void onBlockAdded(World world, int x, int y, int z) {
        if (world.provider.dimensionId ==  0 || world.provider.dimensionId == MythicalRegistration.underworld || !BlockPortalBlock.tryToCreatePortal(world, x, y, z)) {
            if (!World.doesBlockHaveSolidTopSurface(world, x, y - 1, z) && !this.canNeighborBurn(world, x, y, z)) {
                world.setBlockToAir(x, y, z);
            } else {
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_) {
        this.field_149850_M = new IIcon[] {
            p_149651_1_.registerIcon(this.getTextureName() + "_layer_0"), p_149651_1_.registerIcon(this.getTextureName() + "_layer_1")
        };
    }
